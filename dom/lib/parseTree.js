...
function parseTree(vTree) {
  if (vTree.observe) {
    ...
    return _most2.default.zip.apply(_most2.default, [combineVTreeStreams, _most2.default.just(vTree)].concat(_toConsumableArray((0, _map2.default)(vTree.children, parseTree))));
